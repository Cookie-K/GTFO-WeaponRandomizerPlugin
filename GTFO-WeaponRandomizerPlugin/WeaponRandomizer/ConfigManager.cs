...
namespace WeaponRandomizerPlugin.WeaponRandomizer
{
    public static class ConfigManager
    {
        ...
        private static readonly ConfigEntry<bool> HammerLimit = ConfigFile
            .Bind("Hammers", nameof (TreatHammersAsOne), true, 
                "Reduces the chances of getting a hammer such that it is equal to the chance of selecting other melee types.");
        ...
        public static bool TreatHammersAsOne => HammerLimit.Value;
    }
}